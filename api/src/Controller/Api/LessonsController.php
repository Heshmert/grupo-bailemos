...
class LessonsController extends AppController
{
    ...
    public function index()
    {
        $query = $this->Lessons->find()
            ->contain(['Schedules', 'Programs', 'Contents']);
    ...
    {
        $lesson = $this->Lessons->get($id, contain: ['Schedules', 'Programs', 'Contents', 'AcademicProgress', 'Assistances']);
    ...
    public function add()
    {
        ...
        $schedules = $this->Lessons->Schedules->find('list', limit: 200)->all();
        $programs = $this->Lessons->Programs->find('list', limit: 200)->all();
        $contents = $this->Lessons->Contents->find('list', limit: 200)->all();
        $this->set(compact('lesson', 'schedules', 'programs', 'contents'));
    }
